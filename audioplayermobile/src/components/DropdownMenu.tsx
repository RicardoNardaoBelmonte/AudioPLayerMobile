...
const DropdownMenu: React.FC<IDropdown> = ({isOpen}) => {
    return(
        <div className={`fixed top-10 left-1 z-50 h-20 w-30 rounded border border-black bg-background p-1 transition-all duration-300 ease-in-out origin-top min-h-[10rem] min-w-[9rem]
